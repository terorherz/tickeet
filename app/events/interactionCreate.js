...
module.exports = async (client, int) => {
    ...
    switch (req) {
        case 'createTicket': {
            ...
            selectMenu.setPlaceholder('Bilet için bir neden seçiniz.');
            selectMenu.addOptions([

                {
                    emoji: '🎫',
                    label: 'Öneri, destek talebi',
                    description: 'Herhangi bir konuda destek alın!',
            ...
            return int.reply({ content: 'Bileti açma sebebiniz nedir?', components: [row], ephemeral: true });
        }
